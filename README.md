...
This project shows the end-to-end implimentation of Relational Heterogenous Graph Neural Networks (RHGNNs) fraud detection in financial ecosystem.
...
In the proposed idea, power of neural networks were blended with the time-series based finance dataset and fraud trends were recorded and the model is being trained based on the fraud trend.
